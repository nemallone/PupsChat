...
9. Логирование сообщений и команд всех игроков

## Главное примечание

Этот плагин создавался как самопис под мой личный сервер, и на данный момент находится в **не приоритетном** состоянии
